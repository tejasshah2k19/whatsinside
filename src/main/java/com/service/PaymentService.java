...
public class PaymentService {
	...
	public ANetApiResponse chargeCreditCard(String apiLoginId, String transactionKey, Double amount,PaymentBean paymentBean) {
		...
		creditCard.setExpirationDate(paymentBean.getExpDate());
